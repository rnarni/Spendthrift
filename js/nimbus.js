...
// Built on Sun Feb 16 17:40:28 EST 2014
...
(function() {
    ...
    if (typeof window !== "undefined" && window !== null) {
        if (window.atob && window.btoa) {
            ...
            btoaNibble = function(accumulator, bytes, result) {
                ...
                i = 3;
                while (i >= limit) {
                    result.push(base64Digits.charAt(accumulator >> i * 6 & 63));
                    i -= 1
                }
                i = bytes;
                while (i < 3) {
            ...
            atobNibble = function(accumulator, digits, result) {
                ...
                i = 2;
                while (i >= limit) {
                    result.push(String.fromCharCode(accumulator >> 8 * i & 255));
                    i -= 1
                }
                return null
            };
    ...
    Dropbox.Client = function() {
        ...
        Client.prototype.authenticate = function(callback) {
            var oldAuthState, _fsmStep, _this = this;
            oldAuthState = null;
            _fsmStep = function() {
                var authUrl;
    ...
    Dropbox.Drivers.NodeServer = function() {
        ...
        NodeServer.prototype.doRequest = function(request, response) {
            var data, match, token, _this = this;
    ...
    hmacSha1 = function(string, key, length, keyLength) {
        ...
        opad = function() {
            ...
            _results = [];
            for (i = _i = 0; _i < 16; i = ++_i) {
                _results.push(key[i] ^ 1549556828)
            }
            return _results
        }();
    ...
    sha1 = function(string, length) {
        ...
        string[length >> 2] |= 1 << 31 - ((length & 3) << 3);
    ...
    arrayToBase64 = function(array) {
        ...
        while (i < limit) {
            i2 = i;
            trit = (array[i2 >> 2] >> (3 - (i2 & 3) << 3) & 255) << 16;
            i2 += 1;
            trit |= (array[i2 >> 2] >> (3 - (i2 & 3) << 3) & 255) << 8;
            i2 += 1;
            trit |= array[i2 >> 2] >> (3 - (i2 & 3) << 3) & 255;
            string += _base64Digits[trit >> 18 & 63];
            string += _base64Digits[trit >> 12 & 63];
            i += 1;
            if (i >= limit) {
                string += "="
            } else {
                string += _base64Digits[trit >> 6 & 63]
            }
            i += 1;
            if (i >= limit) {
                string += "="
            } else {
                string += _base64Digits[trit & 63]
            }
            i += 1
        }
        return string
    ...
    Dropbox.Oauth = function() {
        ...
        Oauth.prototype.boilerplateParams = function(params) {
            ...
            params.oauth_timestamp = Math.floor(Date.now() / 1e3);
            ...
            if (metadataJson != null ? metadataJson.length : void 0) {
                ...
                if (responseType === "b") {
                    ...
                    for (i = _i = 0, _ref = dirtyText.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
                        bytes.push(String.fromCharCode(dirtyText.charCodeAt(i) & 255))
                    }
                    text = bytes.join("");
    ...
    Nimbus.Client.GDrive = {
        ...
        add_share_user: function(email, callback) {
            var app_folder_id, params, process, _this = this;
            log("&&& add share user");
        ...
        add_share_user_real: function(email, callback, file_id) {
            var fid, params, process, _this = this;
            log("&&& add share user");
    ...
    Nimbus.Model.GDrive = {
        ...
        update_to_cloud: function(object, callback) {
            var comeback, parent, parent_name, update_comback, _this = this;
            log("updated to cloud", object.name);
            parent_name = object.parent.name;
            parent = window.folder[parent_name].id;
        ...
        load_all_from_cloud: function() {
            var fill_cache, folder_id, object_name, _this = this;
            log("loads all the data from the cloud locally");
            this.cloudcache = {};
    ...
    Nimbus.Auth.GDrive = {
        ...
        oauth2_authorize_second_half: function() {
            ...
            if (localStorage._nimbusGDriveAuthObj != null) {
                ...
                issued_at = Math.round(url_obj.saved_time / 1e3);
    ...
    Nimbus.track = {
        ...
        report_storage_stat: function() {
            ...
            if (last_reported_date) {
                if (now - last_reported_date > 864e5) {
