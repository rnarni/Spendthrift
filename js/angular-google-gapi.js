...
angular.module('angular-google-gapi').factory('GAuth', ['$rootScope', '$q','$http','GClient', 'GApi', 'GData', '$interval', '$window', '$location',
    function($rootScope, $q,$http, GClient, GApi, GData, $interval, $window){
        var isLoad = false;
